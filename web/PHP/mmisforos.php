...
if($conexion){
    $query = mysqli_query($conexion,"SELECT * FROM `foros` WHERE `IdCreador` = '$idc' limit 0,10");
    ...
    <div id="foro" class="foro">
      ...
      <div class="row">
        ...
        <div class="col-1-of-3"><a href="../foros.php/?ReplicaCtrl=<?php echo $idc ?>&tipo=<?php echo $tipo?>&idF=<?php echo $idf ?>" id="Ir al foro">Ir al foro</a></div>
      </div>
